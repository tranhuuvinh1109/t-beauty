              ...
              <table className="table-auto w-full text-left border-collapse border">
                <tbody>
                  <tr>
                    ...
                    <td className="border px-4 py-2 text-right">$8.497,00</td>
                  </tr>
                  <tr>
                    <td className="border px-4 py-2 font-bold">
                      Discount (20%)
                    </td>
                    <td className="border px-4 py-2 text-right">$1.699,40</td>
                  </tr>
                  <tr>
                    <td className="border px-4 py-2 font-bold">VAT (10%)</td>
                    <td className="border px-4 py-2 text-right">$679,76</td>
                  </tr>
                  <tr>
